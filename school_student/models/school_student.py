...
class SchoolStudent(models.Model):
    ...
    student_phone_no = fields.Char(string='Student Contact no:', required=True)
    student_gender = fields.Selection([('male', 'male'), ('female', 'female'), ('other', 'other')], default='male',
                                      required=True)

    parent_name = fields.Char(string="Father or Mother Name", required=True)
    parent_phone = fields.Char(string="Contact No", required=True)
    street_name = fields.Char(string="Street", required=True)
