...
class CreateFormToLead(http.Controller):
    ...
    @http.route('/lead/submit/button', type="http", auth="public", website=True, methods=['GET','POST'], csrf=False)
    def submit_button_click(self, **post):

        print("__________submit_button_click_____")
        ...
        # })
        # return request.render("crm_lead_create.thank_you")
